...
function Card( {username = "ChaiKeSathBiscute"} ){ // react say it is props 
    ...
    return(
      ...
      <div className="relative overflow-hidden rounded-lg mb-6">
        ...
        />
        <div className="absolute inset-0 bg-linear-30 from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
      ...
      <div className="mb-4">
        <span className="inline-block px-3 py-1 text-xs font-medium tracking-wider uppercase bg-white text-black rounded-full mb-3">
          Featured
          <br></br>
          <p> This is the king of WebD : {username}</p>
        </span>
